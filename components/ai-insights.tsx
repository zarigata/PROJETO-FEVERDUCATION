...
import { Sparkles, X, AlertTriangle, TrendingUp, TrendingDown, Lightbulb, Maximize2, Minimize2 } from "lucide-react"
...
export function AIInsights() {
  ...
  // Use Dialog for fullscreen mode
      ...
      <Dialog open={true} onOpenChange={() => setIsFullscreen(false)}>
        <DialogContent className="max-w-4xl max-h-[90vh]">
          <DialogHeader>
            ...
            <DialogDescription>Comprehensive analysis of your teaching data and student performance</DialogDescription>
          </DialogHeader>
          <div className="space-y-4 mt-4 overflow-y-auto max-h-[60vh] p-1">
          ...
          <CardFooter className="flex justify-between border-t bg-muted/50 px-6 py-3 mt-4">
